...
SELECT descricao 'Descrição', preco 'Preço', FORMAT (preco + (preco * 0.35), '#.00') 'novo valor com aumento de 35%' FROM Servicos
SELECT nome FROM Hospedes WHERE dataNascimento >= '01-01-1990' AND dataNascimento <= '31-12-1990'
